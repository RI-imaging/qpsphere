...
# -*- coding: utf-8 -*-
#
# qpsphere documentation build configuration file, created by
...
rst_prolog = """
:github_url: https://github.com/RI-imaging/qpsphere
"""
...
latex_documents = [
    (master_doc, 'qpsphere.tex', 'qpsphere Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'qpsphere', 'qpsphere Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qpsphere', 'qpsphere Documentation',
     author, 'qpsphere', 'One line description of project.',
     'Miscellaneous'),
]
